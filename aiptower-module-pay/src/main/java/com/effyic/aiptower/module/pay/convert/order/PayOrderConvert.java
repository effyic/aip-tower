package com.effyic.aiptower.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.effyic.aiptower.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
