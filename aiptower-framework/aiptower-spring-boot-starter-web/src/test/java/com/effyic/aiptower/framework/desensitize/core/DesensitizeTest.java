package com.effyic.aiptower.framework.desensitize.core;
...
import com.effyic.aiptower.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.effyic.aiptower.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.effyic.aiptower.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("AIP-Tower");
        ...
        desensitizeDemo.setRegex("你好，我是AIP-Tower");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("AIP-Tower");
        ...
        assertEquals("AIP-Tower", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "AIP-Tower", replacer = "*")
