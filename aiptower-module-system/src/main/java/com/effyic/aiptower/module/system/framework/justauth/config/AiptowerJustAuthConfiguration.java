package com.effyic.aiptower.module.system.framework.justauth.config;
...
/**
 * JustAuth 配置类 TODO 管理员：等 justauth 1.4.1 版本发布！！！
 *
 * @author effyic
 */
@Configuration(proxyBeanMethods = false)
@EnableConfigurationProperties({JustAuthProperties.class})
public class AiptowerJustAuthConfiguration {
