package com.effyic.aiptower.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${aiptower.websocket.sender-rocketmq.topic}",
        consumerGroup = "${aiptower.websocket.sender-rocketmq.consumer-group}",
