package com.effyic.aiptower.module.infra.controller.admin.codegen;
...
import com.effyic.aiptower.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.effyic.aiptower.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.effyic.aiptower.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.effyic.aiptower.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.effyic.aiptower.module.infra.convert.codegen.CodegenConvert;
...
import com.effyic.aiptower.module.infra.service.codegen.CodegenService;
...
import static com.effyic.aiptower.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static com.effyic.aiptower.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "aiptower"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "AIP-Tower")
    })
