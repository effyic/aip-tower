...
import com.effyic.aiptower.module.iot.gateway.protocol.coap.IotCoapConfig;
import com.effyic.aiptower.module.iot.gateway.protocol.emqx.IotEmqxConfig;
import com.effyic.aiptower.module.iot.gateway.protocol.http.IotHttpConfig;
import com.effyic.aiptower.module.iot.gateway.protocol.modbus.tcpclient.IotModbusTcpClientConfig;
import com.effyic.aiptower.module.iot.gateway.protocol.modbus.tcpserver.IotModbusTcpServerConfig;
import com.effyic.aiptower.module.iot.gateway.protocol.mqtt.IotMqttConfig;
import com.effyic.aiptower.module.iot.gateway.protocol.tcp.IotTcpConfig;
import com.effyic.aiptower.module.iot.gateway.protocol.udp.IotUdpConfig;
import com.effyic.aiptower.module.iot.gateway.protocol.websocket.IotWebSocketConfig;
...
@ConfigurationProperties(prefix = "aiptower.iot.gateway")
@Validated
@Data
public class IotGatewayProperties {
    ...
    public static class ProtocolProperties {
         ...
         * 协议类型
         *
         * @see com.effyic.aiptower.module.iot.core.enums.IotProtocolTypeEnum
         */
         ...
         * 序列化类型（可选）
         *
         * @see com.effyic.aiptower.module.iot.core.enums.IotSerializeTypeEnum
         *
         * 为什么是可选的呢？
