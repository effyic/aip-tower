package com.effyic.aiptower.module.mp.controller.admin.menu.vo;
...
import static com.effyic.aiptower.module.mp.framework.mp.core.util.MpUtils.*;
...
public class MpMenuBaseVO {
    ...
    @Schema(description = "网页链接", example = "https://www.effyic.com/")
