package com.effyic.aiptower.module.member.controller.app.user.vo;
...
public class AppMemberUserInfoRespVO {
    ...
    @Schema(description = "用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.effyic.com/xxx.png")
