package com.effyic.aiptower.module.bpm.service.task;
...
import com.effyic.aiptower.framework.common.util.object.PageUtils;
import com.effyic.aiptower.framework.datapermission.core.annotation.DataPermission;
import com.effyic.aiptower.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import com.effyic.aiptower.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import com.effyic.aiptower.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import com.effyic.aiptower.module.bpm.controller.admin.task.vo.instance.*;
import com.effyic.aiptower.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import com.effyic.aiptower.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import com.effyic.aiptower.module.bpm.convert.task.BpmProcessInstanceConvert;
import com.effyic.aiptower.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.effyic.aiptower.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import com.effyic.aiptower.module.bpm.enums.ErrorCodeConstants;
import com.effyic.aiptower.module.bpm.enums.definition.BpmModelTypeEnum;
import com.effyic.aiptower.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import com.effyic.aiptower.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import com.effyic.aiptower.module.bpm.enums.task.BpmReasonEnum;
import com.effyic.aiptower.module.bpm.enums.task.BpmTaskStatusEnum;
import com.effyic.aiptower.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import com.effyic.aiptower.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import com.effyic.aiptower.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import com.effyic.aiptower.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.effyic.aiptower.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import com.effyic.aiptower.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import com.effyic.aiptower.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import com.effyic.aiptower.module.bpm.framework.flowable.core.util.FlowableUtils;
import com.effyic.aiptower.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import com.effyic.aiptower.module.bpm.service.definition.BpmProcessDefinitionService;
import com.effyic.aiptower.module.bpm.service.message.BpmMessageService;
import com.effyic.aiptower.module.system.api.dept.DeptApi;
import com.effyic.aiptower.module.system.api.dept.dto.DeptRespDTO;
...
import static com.effyic.aiptower.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static com.effyic.aiptower.module.bpm.enums.ErrorCodeConstants.*;
import static com.effyic.aiptower.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static com.effyic.aiptower.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    private List<ActivityNode> getSimulateApproveNodeList(Long startUserId, BpmnModel bpmnModel,
        ...
        // TODO @管理员：【可优化】在驳回场景下，未来的预测准确性不高。原因是，驳回后，HistoricActivityInstance
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/aiptower-cloud/issues/ID1UYA
