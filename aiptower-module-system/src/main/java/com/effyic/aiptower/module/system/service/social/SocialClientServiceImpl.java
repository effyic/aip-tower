package com.effyic.aiptower.module.system.service.social;
...
import com.effyic.aiptower.framework.common.util.cache.CacheUtils;
...
import com.effyic.aiptower.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.effyic.aiptower.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import com.effyic.aiptower.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.effyic.aiptower.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.effyic.aiptower.module.system.dal.dataobject.social.SocialClientDO;
import com.effyic.aiptower.module.system.dal.mysql.social.SocialClientMapper;
...
import com.effyic.aiptower.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.effyic.aiptower.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.effyic.aiptower.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${aiptower.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${aiptower.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/aiptower-cloud/pulls/230
