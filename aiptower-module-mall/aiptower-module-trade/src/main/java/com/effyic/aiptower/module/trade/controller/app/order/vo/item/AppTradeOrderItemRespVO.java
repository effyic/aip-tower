package com.effyic.aiptower.module.trade.controller.app.order.vo.item;
...
public class AppTradeOrderItemRespVO {
    ...
    private Long spuId;
    @Schema(description = "商品 SPU 名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "AIP-Tower")
    ...
    @Schema(description = "商品图片", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.effyic.com/1.png")
