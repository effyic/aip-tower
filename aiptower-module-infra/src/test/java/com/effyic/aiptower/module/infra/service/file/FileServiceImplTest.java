...
import com.effyic.aiptower.module.infra.controller.admin.file.vo.file.FileCreateReqVO;
...
import com.effyic.aiptower.module.infra.dal.mysql.file.FileMapper;
...
import static com.effyic.aiptower.module.infra.enums.ErrorCodeConstants.FILE_NOT_EXISTS;
import static com.effyic.aiptower.module.infra.enums.ErrorCodeConstants.FILE_PATH_INVALID;
...
public class FileServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileByPresignedPath_success() {
        ...
        FileCreateReqVO reqVO = randomPojo(FileCreateReqVO.class, o -> {
            ...
            o.setName("test.jpg");
            o.setUrl("https://www.effyic.com/test.jpg?token=123");
        });
        ...
        assertEquals("https://www.effyic.com/test.jpg", file.getUrl());
    }
