package com.effyic.aiptower.module.iot.controller.admin.product.vo.product;
...
import com.effyic.aiptower.module.iot.enums.product.IotNetTypeEnum;
...
public class IotProductSaveReqVO {
    ...
    @Schema(description = "产品图标", example = "https://effyic.com/1.svg")
    private String icon;

    @Schema(description = "产品图片", example = "https://effyic.com/1.png")
