package com.effyic.aiptower.module.iot.api.device;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import com.effyic.aiptower.framework.common.enums.RpcConstants;
...
import com.effyic.aiptower.module.iot.core.biz.dto.*;
...
import com.effyic.aiptower.module.iot.dal.dataobject.device.IotDeviceModbusPointDO;
import com.effyic.aiptower.module.iot.dal.dataobject.product.IotProductDO;
import com.effyic.aiptower.module.iot.service.device.IotDeviceModbusConfigService;
...
@RestController
@Validated
@Primary // 保证优先匹配，因为 aiptower-iot-gateway 也有 IotDeviceCommonApi 的实现，并且也可能会被 biz 引入
