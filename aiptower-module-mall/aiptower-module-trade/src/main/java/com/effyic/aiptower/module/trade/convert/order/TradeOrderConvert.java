package com.effyic.aiptower.module.trade.convert.order;
...
import com.effyic.aiptower.framework.ip.core.utils.AreaUtils;
import com.effyic.aiptower.module.member.api.address.dto.MemberAddressRespDTO;
import com.effyic.aiptower.module.member.api.user.dto.MemberUserRespDTO;
...
import com.effyic.aiptower.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import com.effyic.aiptower.module.product.api.sku.dto.ProductSkuRespDTO;
import com.effyic.aiptower.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import com.effyic.aiptower.module.product.api.spu.dto.ProductSpuRespDTO;
import com.effyic.aiptower.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import com.effyic.aiptower.module.trade.api.order.dto.TradeOrderRespDTO;
import com.effyic.aiptower.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import com.effyic.aiptower.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import com.effyic.aiptower.module.trade.controller.admin.order.vo.*;
import com.effyic.aiptower.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import com.effyic.aiptower.module.trade.controller.app.order.vo.*;
import com.effyic.aiptower.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import com.effyic.aiptower.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import com.effyic.aiptower.module.trade.dal.dataobject.order.TradeOrderLogDO;
import com.effyic.aiptower.module.trade.enums.order.TradeOrderItemAfterSaleStatusEnum;
import com.effyic.aiptower.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import com.effyic.aiptower.module.trade.framework.order.config.TradeOrderProperties;
import com.effyic.aiptower.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static com.effyic.aiptower.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/aiptowercode/aiptower-mall-uniapp/issues/ICY7SJ
