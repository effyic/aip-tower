package com.effyic.aiptower.module.erp.controller.admin.stock.vo.out;
...
import static com.effyic.aiptower.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockOutRespVO {
    ...
    @Schema(description = "客户名称", example = "AIP-Tower")
    @ExcelProperty("客户名称")
    ...
    @Schema(description = "附件 URL", example = "https://www.effyic.com/1.doc")
    private String fileUrl;

    @Schema(description = "创建人", example = "AIP-Tower")
    private String creator;
    @Schema(description = "创建人名称", example = "AIP-Tower")
