package com.effyic.aiptower.module.im.service.websocket.dto;
...
import com.effyic.aiptower.module.im.service.websocket.dto.notification.friend.BaseFriendNotification;
...
public class ImPrivateMessageDTO {
     ...
     * 与 {@link com.effyic.aiptower.module.im.service.message.dto.ImGroupMessageSendDTO} 走 sendGroupMessage 群广播路径不同
     *
