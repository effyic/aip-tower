package com.effyic.aiptower.module.system.controller.admin.sms.vo.template;
...
public class SmsTemplateSaveReqVO {
    ...
    @Schema(description = "模板名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "aiptower")
