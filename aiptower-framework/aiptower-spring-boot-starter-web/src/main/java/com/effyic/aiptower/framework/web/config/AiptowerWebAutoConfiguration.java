package com.effyic.aiptower.framework.web.config;
...
import com.effyic.aiptower.framework.web.core.filter.CacheRequestBodyFilter;
import com.effyic.aiptower.framework.web.core.filter.DemoFilter;
import com.effyic.aiptower.framework.web.core.handler.GlobalExceptionHandler;
import com.effyic.aiptower.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class AiptowerWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "aiptower.demo", havingValue = "true")
