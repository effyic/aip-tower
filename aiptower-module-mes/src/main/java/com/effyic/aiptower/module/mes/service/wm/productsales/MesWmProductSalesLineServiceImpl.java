...
import com.effyic.aiptower.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO;
import com.effyic.aiptower.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLineSaveReqVO;
...
import com.effyic.aiptower.module.mes.dal.mysql.wm.productsales.MesWmProductSalesLineMapper;
import com.effyic.aiptower.module.mes.enums.qc.MesQcCheckResultEnum;
...
import com.effyic.aiptower.module.mes.service.wm.salesnotice.MesWmSalesNoticeLineService;
...
public class MesWmProductSalesLineServiceImpl implements MesWmProductSalesLineService {
    ...
    @Override
    public com.effyic.aiptower.framework.common.pojo.PageResult<MesWmProductSalesLineDO> getProductSalesLinePage(
        ...
        if (pageReqVO.getSalesId() == null && pageReqVO.getClientId() != null) {
            ...
            if (CollUtil.isEmpty(salesList)) {
                return com.effyic.aiptower.framework.common.pojo.PageResult.empty();
            }
