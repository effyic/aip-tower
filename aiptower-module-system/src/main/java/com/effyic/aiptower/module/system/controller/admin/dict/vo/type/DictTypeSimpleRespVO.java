package com.effyic.aiptower.module.system.controller.admin.dict.vo.type;
...
public class DictTypeSimpleRespVO {
    ...
    @Schema(description = "字典类型名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "AIP-Tower")
    private String name;
