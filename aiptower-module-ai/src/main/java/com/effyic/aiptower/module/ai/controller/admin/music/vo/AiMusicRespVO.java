package com.effyic.aiptower.module.ai.controller.admin.music.vo;
...
public class AiMusicRespVO {
    ...
    @Schema(description = "图片地址", example = "https://www.effyic.com")
    private String imageUrl;

    @Schema(description = "音频地址", example = "https://www.effyic.com")
    private String audioUrl;

    @Schema(description = "视频地址", example = "https://www.effyic.com")
