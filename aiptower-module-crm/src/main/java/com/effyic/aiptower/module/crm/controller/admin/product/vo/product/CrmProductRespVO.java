package com.effyic.aiptower.module.crm.controller.admin.product.vo.product;
...
import com.effyic.aiptower.module.crm.enums.DictTypeConstants;
...
public class CrmProductRespVO implements VO {
    ...
    @Trans(type = TransType.SIMPLE, targetClassName = "com.effyic.aiptower.module.system.dal.dataobject.user.AdminUserDO",
            fields = "nickname", ref = "ownerUserName")
    private Long ownerUserId;
    @Schema(description = "负责人的用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "AIP-Tower")
    @ExcelProperty("负责人")
    ...
    @Schema(description = "创建人名字", requiredMode = Schema.RequiredMode.REQUIRED, example = "AIP-Tower")
    @ExcelProperty("创建人")
