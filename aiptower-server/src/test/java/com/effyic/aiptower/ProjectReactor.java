...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.effyic";
    private static final String ARTIFACT_ID = "aiptower";
    private static final String PACKAGE_NAME = "com.effyic.aiptower";
    private static final String TITLE = "AIP-Tower";
    ...
    public static void main(String[] args) {
        ...
        // ========== AIP-Tower ==========
        String groupIdNew = "com.effyic";
        String artifactIdNew = "aiptower";
        String packageNameNew = "com.effyic.aiptower";
        String titleNew = "AIP-Tower";
        String projectBaseDirNew = "/Users/mac/IdeaProjects/aip-tower";
    ...
    private static String getProjectBaseDir() {
        ...
        // 支持在 aiptower-server 子模块运行：自动定位到根目录
        File dir = new File(baseDir);
        if (new File(dir, "aiptower-server").isDirectory() && new File(dir, "pom.xml").isFile()) {
            return dir.getAbsolutePath();
        }
        File parent = dir.getParentFile();
        if (parent != null && new File(parent, "aiptower-server").isDirectory() && new File(parent, "pom.xml").isFile()) {
    ...
    private static String replaceFileContent(File file, String groupIdNew,
        ...
        return content.replaceAll(GROUP_ID, groupIdNew)
                ...
                .replace("aip-tower", "aip-tower") // 目录/仓库名（连字符）
                .replace("AIP-Tower", titleNew)
