package com.effyic.aiptower.module.system.controller.admin.logger.vo.operatelog;
...
public class OperateLogRespVO implements VO {
    ...
    @Schema(description = "操作明细", example = "修改编号为 1 的用户信息，将性别从男改成女，将姓名从AIP-Tower改成源码。")
