package com.effyic.aiptower.module.member.controller.admin.config;

import com.effyic.aiptower.framework.common.pojo.CommonResult;
import com.effyic.aiptower.module.member.controller.admin.config.vo.MemberConfigRespVO;
import com.effyic.aiptower.module.member.controller.admin.config.vo.MemberConfigSaveReqVO;
import com.effyic.aiptower.module.member.convert.config.MemberConfigConvert;
import com.effyic.aiptower.module.member.dal.dataobject.config.MemberConfigDO;
import com.effyic.aiptower.module.member.service.config.MemberConfigService;
