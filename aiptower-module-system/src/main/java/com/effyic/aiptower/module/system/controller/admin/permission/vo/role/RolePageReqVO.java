package com.effyic.aiptower.module.system.controller.admin.permission.vo.role;
...
public class RolePageReqVO extends PageParam {
    ...
    @Schema(description = "角色名称，模糊匹配", example = "AIP-Tower")
    private String name;

    @Schema(description = "角色标识，模糊匹配", example = "aiptower")
    private String code;
    ...
    /**
     * 排除的角色标识（内部使用，非超管查询时排除 super_admin）
     */
    @Schema(hidden = true)
