package com.effyic.aiptower.module.infra.service.file;
...
import com.effyic.aiptower.module.infra.dal.mysql.file.FileConfigMapper;
import com.effyic.aiptower.module.infra.framework.file.core.client.FileClient;
import com.effyic.aiptower.module.infra.framework.file.core.client.FileClientConfig;
import com.effyic.aiptower.module.infra.framework.file.core.client.FileClientFactory;
import com.effyic.aiptower.module.infra.framework.file.core.client.local.LocalFileClient;
import com.effyic.aiptower.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import com.effyic.aiptower.module.infra.framework.file.core.enums.FileStorageEnum;
...
import static com.effyic.aiptower.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.effyic.aiptower.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileConfig_success() {
        ...
        Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/yunai")
                .put("domain", "https://www.effyic.com").build();
        ...
        assertEquals("https://www.effyic.com", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // 验证 cache
    ...
    public void testUpdateFileConfig_success() {
        ...
        FileConfigDO dbFileConfig = randomPojo(FileConfigDO.class, o -> o.setStorage(FileStorageEnum.LOCAL.getStorage())
                .setConfig(new LocalFileClientConfig().setBasePath("/yunai").setDomain("https://www.effyic.com")));
        ...
        FileConfigSaveReqVO reqVO = randomPojo(FileConfigSaveReqVO.class, o -> {
            ...
            Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/yunai2")
                    .put("domain", "https://effyic.com").build();
            o.setConfig(config);
        });
        ...
        assertEquals("https://effyic.com", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // 验证 cache
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("AIP-Tower")
    ...
    public void testFileConfig() throws Exception {
        ...
        when(fileClient.upload(any(), any(), any())).thenReturn("https://www.effyic.com");

        // 调用，并断言
        assertEquals("https://www.effyic.com", fileConfigService.testFileConfig(id));
    }
