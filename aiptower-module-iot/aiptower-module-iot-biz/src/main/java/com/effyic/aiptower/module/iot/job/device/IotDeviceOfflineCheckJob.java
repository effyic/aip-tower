package com.effyic.aiptower.module.iot.job.device;
...
import com.effyic.aiptower.module.iot.framework.iot.config.AiptowerIotProperties;
...
public class IotDeviceOfflineCheckJob implements JobHandler {
    ...
    @Resource
    private AiptowerIotProperties iotProperties;
