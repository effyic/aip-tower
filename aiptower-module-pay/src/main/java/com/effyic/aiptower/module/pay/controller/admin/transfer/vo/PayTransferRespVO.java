package com.effyic.aiptower.module.pay.controller.admin.transfer.vo;
...
public class PayTransferRespVO {
    ...
    @Schema(description = "异步通知商户地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.effyic.com")
