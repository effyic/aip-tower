package com.effyic.aiptower.module.product.controller.app.comment.vo;

import com.effyic.aiptower.module.product.controller.app.property.vo.value.AppProductPropertyValueDetailRespVO;
...
public class AppProductCommentRespVO {
    ...
    @Schema(description = "追评评价图片地址数组，以逗号分隔最多上传 9 张", example = "[https://www.effyic.com/xx.png, https://www.effyic.com/xxx.png]")
    ...
    @Schema(description = "评论图片地址数组，以逗号分隔最多上传 9 张", requiredMode = Schema.RequiredMode.REQUIRED,
            example = "[https://www.effyic.com/xx.png]")
