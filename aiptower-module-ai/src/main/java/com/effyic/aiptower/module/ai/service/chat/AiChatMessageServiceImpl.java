package com.effyic.aiptower.module.ai.service.chat;
...
import com.effyic.aiptower.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import com.effyic.aiptower.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import com.effyic.aiptower.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import com.effyic.aiptower.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import com.effyic.aiptower.module.ai.dal.dataobject.chat.AiChatConversationDO;
import com.effyic.aiptower.module.ai.dal.dataobject.chat.AiChatMessageDO;
import com.effyic.aiptower.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import com.effyic.aiptower.module.ai.dal.dataobject.model.AiChatRoleDO;
import com.effyic.aiptower.module.ai.dal.dataobject.model.AiModelDO;
import com.effyic.aiptower.module.ai.dal.dataobject.model.AiToolDO;
import com.effyic.aiptower.module.ai.dal.mysql.chat.AiChatMessageMapper;
import com.effyic.aiptower.module.ai.enums.ErrorCodeConstants;
...
import com.effyic.aiptower.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import com.effyic.aiptower.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import com.effyic.aiptower.module.ai.service.knowledge.AiKnowledgeDocumentService;
import com.effyic.aiptower.module.ai.service.knowledge.AiKnowledgeSegmentService;
import com.effyic.aiptower.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import com.effyic.aiptower.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import com.effyic.aiptower.module.ai.service.model.AiChatRoleService;
import com.effyic.aiptower.module.ai.service.model.AiModelService;
import com.effyic.aiptower.module.ai.service.model.AiToolService;
import com.effyic.aiptower.module.ai.util.AiUtils;
import com.effyic.aiptower.module.ai.util.FileTypeUtils;
...
import static com.effyic.aiptower.framework.common.pojo.CommonResult.error;
...
import static com.effyic.aiptower.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static com.effyic.aiptower.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 aiptower.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 aiptower.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
