package com.effyic.aiptower.module.product.controller.app.spu.vo;
...
public class AppProductSpuDetailRespVO {
    ...
    @Schema(description = "商品名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "AIP-Tower")
    private String name;
    ...
    public static class Sku {
        ...
        @Schema(description = "图片地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.effyic.com/xx.png")
        private String picUrl;
