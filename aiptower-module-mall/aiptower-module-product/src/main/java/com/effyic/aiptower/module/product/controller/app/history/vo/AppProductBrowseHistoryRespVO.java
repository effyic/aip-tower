package com.effyic.aiptower.module.product.controller.app.history.vo;
...
public class AppProductBrowseHistoryRespVO {
    ...
    @Schema(description = "商品封面图", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.effyic.com/pic.png")
