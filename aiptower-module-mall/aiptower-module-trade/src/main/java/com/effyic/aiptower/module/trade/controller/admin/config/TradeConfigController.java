package com.effyic.aiptower.module.trade.controller.admin.config;

import com.effyic.aiptower.framework.common.pojo.CommonResult;
import com.effyic.aiptower.module.trade.controller.admin.config.vo.TradeConfigRespVO;
import com.effyic.aiptower.module.trade.controller.admin.config.vo.TradeConfigSaveReqVO;
import com.effyic.aiptower.module.trade.convert.config.TradeConfigConvert;
...
public class TradeConfigController {
    ...
    @Value("${aiptower.tencent-lbs-key}")
