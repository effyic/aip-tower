package com.effyic.aiptower.module.wms.controller.admin.order.shipment.vo.order;
...
import com.effyic.aiptower.module.wms.enums.DictTypeConstants;
...
public class WmsShipmentOrderRespVO {
    ...
    @Schema(description = "创建者名称", example = "AIP-Tower")
    ...
    @Schema(description = "更新者名称", example = "AIP-Tower")
