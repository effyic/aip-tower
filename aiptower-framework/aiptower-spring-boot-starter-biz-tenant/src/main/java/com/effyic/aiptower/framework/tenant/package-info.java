 ...
 *      1）Spring Async：
 *          {@link com.effyic.aiptower.framework.quartz.config.AiptowerAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 AiptowerSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.effyic.aiptower.framework.tenant;
