package com.effyic.aiptower.module.infra.controller.admin.demo.demo03.normal.vo;
...
public class Demo03StudentNormalSaveReqVO {
    ...
    @Schema(description = "名字", requiredMode = Schema.RequiredMode.REQUIRED, example = "管理员")
