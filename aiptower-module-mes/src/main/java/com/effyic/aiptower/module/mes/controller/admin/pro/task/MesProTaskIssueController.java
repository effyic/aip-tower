...
import com.effyic.aiptower.module.mes.controller.admin.pro.task.vo.MesProTaskIssuePageReqVO;
import com.effyic.aiptower.module.mes.controller.admin.pro.task.vo.MesProTaskIssueRespVO;
import com.effyic.aiptower.module.mes.controller.admin.pro.task.vo.MesProTaskIssueSaveReqVO;
...
import com.effyic.aiptower.module.mes.dal.dataobject.pro.task.MesProTaskIssueDO;
...
import com.effyic.aiptower.module.mes.service.pro.task.MesProTaskIssueService;
...
public class MesProTaskIssueController {
    ...
    private List<MesProTaskIssueRespVO> buildIssueRespVOList(List<MesProTaskIssueDO> list) {
        ...
        // 拼接 VO
        return com.effyic.aiptower.framework.common.util.collection.CollectionUtils.convertList(list, issue -> {
