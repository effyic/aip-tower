package com.effyic.aiptower.module.infra.service.logger;
...
import com.effyic.aiptower.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.effyic.aiptower.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.effyic.aiptower.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.effyic.aiptower.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.effyic.aiptower.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.effyic.aiptower.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("aiptower-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("aiptower-test");
    ...
    public void testCleanJobLog() {
        ...
        // TODO @管理员：createTime updateTime 被屏蔽，仅 win11 会复现，建议后续修复。
