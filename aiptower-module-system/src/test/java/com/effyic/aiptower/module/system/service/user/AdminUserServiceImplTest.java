package com.effyic.aiptower.module.system.service.user;
...
import com.effyic.aiptower.module.infra.api.config.ConfigApi;
import com.effyic.aiptower.module.infra.api.file.FileApi;
import com.effyic.aiptower.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.effyic.aiptower.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.effyic.aiptower.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.effyic.aiptower.module.system.controller.admin.user.vo.user.UserImportRespVO;
...
import com.effyic.aiptower.module.system.dal.dataobject.dept.PostDO;
import com.effyic.aiptower.module.system.dal.dataobject.dept.UserPostDO;
...
import com.effyic.aiptower.module.system.dal.mysql.dept.UserPostMapper;
...
import com.effyic.aiptower.module.system.mq.producer.user.AdminUserProducer;
import com.effyic.aiptower.module.system.service.dept.DeptService;
import com.effyic.aiptower.module.system.service.dept.PostService;
...
import static com.effyic.aiptower.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("aiptoweryuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("aiptoweryuanma");
        ...
        assertEquals("aiptoweryuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("aiptoweryuanma"))).thenReturn("java");
