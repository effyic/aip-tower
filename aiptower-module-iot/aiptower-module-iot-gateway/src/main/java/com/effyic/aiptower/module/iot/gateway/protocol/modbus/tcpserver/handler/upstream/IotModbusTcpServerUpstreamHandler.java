package com.effyic.aiptower.module.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import com.effyic.aiptower.framework.common.exception.enums.GlobalErrorCodeConstants;
...
import com.effyic.aiptower.module.iot.core.biz.IotDeviceCommonApi;
import com.effyic.aiptower.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import com.effyic.aiptower.module.iot.core.biz.dto.IotDeviceRespDTO;
import com.effyic.aiptower.module.iot.core.biz.dto.IotModbusDeviceConfigRespDTO;
import com.effyic.aiptower.module.iot.core.biz.dto.IotModbusPointRespDTO;
import com.effyic.aiptower.module.iot.core.enums.IotDeviceMessageMethodEnum;
import com.effyic.aiptower.module.iot.core.enums.modbus.IotModbusFrameFormatEnum;
...
import com.effyic.aiptower.module.iot.core.util.IotDeviceAuthUtils;
import com.effyic.aiptower.module.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import com.effyic.aiptower.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import com.effyic.aiptower.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import com.effyic.aiptower.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import com.effyic.aiptower.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import com.effyic.aiptower.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import com.effyic.aiptower.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import com.effyic.aiptower.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import com.effyic.aiptower.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import com.effyic.aiptower.module.iot.gateway.service.device.IotDeviceService;
import com.effyic.aiptower.module.iot.gateway.service.device.message.IotDeviceMessageService;
import io.vertx.core.net.NetSocket;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static com.effyic.aiptower.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.effyic.aiptower.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.effyic.aiptower.framework.common.exception.util.ServiceExceptionUtil.invalidParamException;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link com.effyic.aiptower.module.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
