...
import com.effyic.aiptower.module.system.dal.dataobject.sms.SmsCodeDO;
import com.effyic.aiptower.module.system.dal.mysql.sms.SmsCodeMapper;
import com.effyic.aiptower.module.system.enums.sms.SmsSceneEnum;
import com.effyic.aiptower.module.system.framework.sms.config.SmsCodeProperties;
...
import static com.effyic.aiptower.framework.common.util.date.DateUtils.isToday;
...
public class SmsCodeServiceImpl implements SmsCodeService {
    ...
    private String createSmsCode(String mobile, Integer scene, String ip) {
        ...
        if (lastSmsCode != null) {
            ...
            // TODO 管理员：提升，每个 IP 每天可发送数量
            // TODO 管理员：提升，每个 IP 每小时可发送数量
        }
