package com.effyic.aiptower.module.iot.service.device.property;
...
import com.effyic.aiptower.module.iot.controller.admin.device.vo.property.IotDevicePropertyHistoryListReqVO;
import com.effyic.aiptower.module.iot.controller.admin.device.vo.property.IotDevicePropertyRespVO;
...
import com.effyic.aiptower.module.iot.dal.dataobject.device.IotDevicePropertyDO;
import com.effyic.aiptower.module.iot.dal.dataobject.product.IotProductDO;
import com.effyic.aiptower.module.iot.dal.dataobject.thingmodel.IotThingModelDO;
import com.effyic.aiptower.module.iot.dal.dataobject.thingmodel.model.dataType.ThingModelDateOrTextDataSpecs;
import com.effyic.aiptower.module.iot.dal.redis.device.DevicePropertyRedisDAO;
import com.effyic.aiptower.module.iot.dal.redis.device.DeviceReportTimeRedisDAO;
import com.effyic.aiptower.module.iot.dal.redis.device.DeviceServerIdRedisDAO;
import com.effyic.aiptower.module.iot.dal.tdengine.IotDevicePropertyMapper;
import com.effyic.aiptower.module.iot.enums.thingmodel.IotDataSpecsDataTypeEnum;
import com.effyic.aiptower.module.iot.enums.thingmodel.IotThingModelTypeEnum;
import com.effyic.aiptower.module.iot.framework.tdengine.core.TDengineTableField;
import com.effyic.aiptower.module.iot.service.device.IotDeviceService;
import com.effyic.aiptower.module.iot.service.product.IotProductService;
import com.effyic.aiptower.module.iot.service.thingmodel.IotThingModelService;
...
import static com.effyic.aiptower.framework.common.util.collection.MapUtils.getBigDecimal;
...
public class IotDevicePropertyServiceImpl implements IotDevicePropertyService {
    ...
    public void saveDeviceProperty(IotDeviceDO device, IotDeviceMessage message) {
        ...
        // 1. 根据物模型，拼接合法的属性
        // TODO @管理员：【待定 004】赋能后，属性到底以 thingModel 为准（ik），还是 db 的表结构为准（tl）？
