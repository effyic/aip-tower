...
import com.effyic.aiptower.framework.common.util.http.HttpUtils;
...
import com.effyic.aiptower.module.system.convert.oauth2.OAuth2OpenConvert;
...
import com.effyic.aiptower.module.system.util.oauth2.OAuth2Utils;
...
import static com.effyic.aiptower.framework.common.exception.util.ServiceExceptionUtil.exception0;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "https://www.effyic.com"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "https://www.effyic.com"),
