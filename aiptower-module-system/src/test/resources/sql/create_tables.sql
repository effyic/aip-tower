...
CREATE TABLE IF NOT EXISTS "system_biz_menu" (
    "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    "name" varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS "system_tenant_package" (
    ...
    "triage_agent_limit" int NOT NULL DEFAULT 0,
    "inquiry_agent_limit" int NOT NULL DEFAULT 0,
    "advanced_config_enabled" bit NOT NULL DEFAULT FALSE,
    "custom_case_enabled" bit NOT NULL DEFAULT FALSE,
    "creator" varchar(64) DEFAULT '',
    "create_time" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updater" varchar(64) DEFAULT '',
    "update_time" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
