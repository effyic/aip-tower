package com.effyic.aiptower.module.im.controller.admin.group.vo.request;
...
public class ImGroupRequestRespVO {
    ...
    @Schema(description = "申请人 / 被邀请人昵称（实时聚合自 AdminUser）", example = "AIP-Tower")
    ...
    @Schema(description = "群名称（实时聚合自 ImGroup）", example = "AIP-Tower技术交流群")
