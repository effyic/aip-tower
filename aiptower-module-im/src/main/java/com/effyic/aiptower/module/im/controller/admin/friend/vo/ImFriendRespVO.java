package com.effyic.aiptower.module.im.controller.admin.friend.vo;
...
public class ImFriendRespVO {
    ...
    @Schema(description = "好友昵称（实时聚合自 AdminUser）", example = "AIP-Tower")
    private String nickname;

    @Schema(description = "好友昵称的拼音（小写无空格）", example = "aiptower")
