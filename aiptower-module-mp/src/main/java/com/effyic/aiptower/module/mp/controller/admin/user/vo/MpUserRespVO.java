package com.effyic.aiptower.module.mp.controller.admin.user.vo;
...
public class MpUserRespVO  {
    ...
    @Schema(description = "昵称", example = "AIP-Tower")
    private String nickname;
    @Schema(description = "头像地址", example = "https://www.effyic.com/1.png")
