package com.effyic.aiptower.module.crm.controller.admin.customer;
...
import com.effyic.aiptower.module.crm.service.customer.CrmCustomerPoolConfigService;
...
public class CrmCustomerController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<CrmCustomerImportExcelVO> list = Arrays.asList(
                CrmCustomerImportExcelVO.builder().name("AIP-Tower").industryId(1).level(1).source(1)
                        .mobile("15601691300").telephone("").qq("").wechat("").email("yunai@effyic.com")
