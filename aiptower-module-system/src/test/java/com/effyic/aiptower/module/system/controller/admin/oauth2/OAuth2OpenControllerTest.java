package com.effyic.aiptower.module.system.controller.admin.oauth2;
...
import com.effyic.aiptower.framework.common.exception.ErrorCode;
...
import com.effyic.aiptower.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import com.effyic.aiptower.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import com.effyic.aiptower.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import com.effyic.aiptower.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import com.effyic.aiptower.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import com.effyic.aiptower.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import com.effyic.aiptower.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import com.effyic.aiptower.module.system.service.oauth2.OAuth2ApproveService;
import com.effyic.aiptower.module.system.service.oauth2.OAuth2ClientService;
import com.effyic.aiptower.module.system.service.oauth2.OAuth2GrantService;
import com.effyic.aiptower.module.system.service.oauth2.OAuth2TokenService;
...
import static com.effyic.aiptower.framework.test.core.util.RandomUtils.randomString;
...
public class OAuth2OpenControllerTest extends BaseMockitoUnitTest {
    ...
    public void testApproveOrDeny_ApproveNo() {
        ...
        String clientId = randomString();
        String scope = "{\"read\": true, \"write\": false}";
        String redirectUri = "https://www.effyic.com";
        String state = "test";
        // mock 方法
        OAuth2ClientDO client = randomPojo(OAuth2ClientDO.class);
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://www.effyic.com#error=access_denied&error_description=User%20denied%20access&state=test", result.getData());
    }
    ...
    public void testApproveOrDeny_autoApproveWithToken() {
        ...
        assertThat(result.getData(), anyOf( // 29 和 30 都有一定概率，主要是时间计算
                is("https://www.effyic.com#access_token=test_access_token&token_type=bearer&state=test&expires_in=29&scope=read"),
                is("https://www.effyic.com#access_token=test_access_token&token_type=bearer&state=test&expires_in=30&scope=read")
        ));
    }
    ...
    public void testApproveOrDeny_approveWithCode() {
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://www.effyic.com?code=test_code&state=test", result.getData());
    }
