package com.effyic.aiptower.module.iot.service.device.message;
...
import com.effyic.aiptower.module.iot.controller.admin.device.vo.message.IotDeviceMessagePageReqVO;
import com.effyic.aiptower.module.iot.controller.admin.statistics.vo.IotStatisticsDeviceMessageReqVO;
import com.effyic.aiptower.module.iot.controller.admin.statistics.vo.IotStatisticsDeviceMessageSummaryByDateRespVO;
...
import com.effyic.aiptower.module.iot.core.mq.producer.IotDeviceMessageProducer;
import com.effyic.aiptower.module.iot.core.topic.IotDeviceIdentity;
import com.effyic.aiptower.module.iot.core.topic.event.IotDeviceEventPostReqDTO;
import com.effyic.aiptower.module.iot.core.topic.property.IotDevicePropertyPackPostReqDTO;
import com.effyic.aiptower.module.iot.core.topic.property.IotDevicePropertyPostReqDTO;
...
import com.effyic.aiptower.module.iot.dal.dataobject.device.IotDeviceMessageDO;
import com.effyic.aiptower.module.iot.dal.tdengine.IotDeviceMessageMapper;
import com.effyic.aiptower.module.iot.service.device.IotDeviceService;
import com.effyic.aiptower.module.iot.service.device.property.IotDevicePropertyService;
import com.effyic.aiptower.module.iot.service.ota.IotOtaTaskRecordService;
...
import static com.effyic.aiptower.module.iot.enums.ErrorCodeConstants.DEVICE_DOWNSTREAM_FAILED_SERVER_ID_NULL;
...
public class IotDeviceMessageServiceImpl implements IotDeviceMessageService {
    ...
    private IotDeviceMessage sendDeviceMessage(IotDeviceMessage message, IotDeviceDO device, String serverId) {
        ...
        // TODO 管理员：【设计】下行消息需要区分 PUSH 和 PULL 模型
    ...
    // TODO @管理员：可优化：未来逻辑复杂后，可以独立拆除 Processor 处理器
