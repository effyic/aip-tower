package com.effyic.aiptower.module.iot.service.rule.action.databridge;
...
import com.effyic.aiptower.module.iot.dal.dataobject.rule.config.*;
import com.effyic.aiptower.module.iot.service.rule.data.action.*;
...
public class IotDataBridgeExecuteTest extends BaseMockitoUnitTest {
    ...
    public void testHttpDataBridge() throws Exception {
        ...
        IotDataSinkHttpConfig config = new IotDataSinkHttpConfig()
                .setUrl("https://effyic.com/").setMethod(HttpMethod.GET.name());
