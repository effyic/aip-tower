package com.effyic.aiptower.module.im.framework.rtc.core;
 ...
 * <p>
 * 由 {@link com.effyic.aiptower.module.im.framework.rtc.config.ImRtcConfiguration} 注册为 Bean，本类不带 {@code @Component}
 *
 * @author effyic
 */
@Slf4j
