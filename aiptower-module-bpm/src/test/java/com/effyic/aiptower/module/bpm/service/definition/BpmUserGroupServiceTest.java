...
import com.effyic.aiptower.module.bpm.controller.admin.definition.vo.group.BpmUserGroupSaveReqVO;
...
import com.effyic.aiptower.module.bpm.dal.mysql.definition.BpmUserGroupMapper;
...
import static com.effyic.aiptower.module.bpm.enums.ErrorCodeConstants.USER_GROUP_NOT_EXISTS;
...
public class BpmUserGroupServiceTest extends BaseDbUnitTest {
    ...
    public void testGetUserGroupPage() {
       ...
       // 测试 name 不匹配
       userGroupMapper.insert(cloneIgnoreId(dbUserGroup, o -> o.setName("AIP-Tower")));
       // 测试 status 不匹配
