package com.effyic.aiptower.module.ai.controller.admin.knowledge.vo.document;
...
public class AiKnowledgeDocumentCreateListReqVO {
    ...
    public static class Document {
        ...
        @Schema(description = "文档 URL", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://effyic.com")
