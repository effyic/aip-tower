package com.effyic.aiptower.module.iot.core.messagebus.config;

import com.effyic.aiptower.framework.mq.redis.core.RedisMQTemplate;
import com.effyic.aiptower.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.effyic.aiptower.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import com.effyic.aiptower.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import com.effyic.aiptower.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import com.effyic.aiptower.module.iot.core.messagebus.core.IotMessageBus;
import com.effyic.aiptower.module.iot.core.messagebus.core.kafka.IotKafkaMessageBus;
import com.effyic.aiptower.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import com.effyic.aiptower.module.iot.core.messagebus.core.rabbitmq.IotRabbitMQMessageBus;
import com.effyic.aiptower.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import com.effyic.aiptower.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "aiptower.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "aiptower.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "aiptower.iot.message-bus", name = "type", havingValue = "kafka")
    ...
    /**
     * 特殊：由于 AiptowerRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see com.effyic.aiptower.framework.mq.redis.config.AiptowerRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "aiptower.iot.message-bus", name = "type", havingValue = "redis")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "aiptower.iot.message-bus", name = "type", havingValue = "rabbitmq")
