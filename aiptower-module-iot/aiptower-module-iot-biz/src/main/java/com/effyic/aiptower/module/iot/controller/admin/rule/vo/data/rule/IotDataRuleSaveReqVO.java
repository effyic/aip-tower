package com.effyic.aiptower.module.iot.controller.admin.rule.vo.data.rule;
...
public class IotDataRuleSaveReqVO {
    ...
    @Schema(description = "数据流转规则名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "管理员")
