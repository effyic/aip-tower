package com.effyic.aiptower.module.product.controller.admin.spu.vo;
...
import com.effyic.aiptower.framework.excel.core.convert.MoneyConvert;
import com.effyic.aiptower.module.product.enums.DictTypeConstants;
...
public class ProductSpuRespVO {
    ...
    @Schema(description = "商品封面图", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.effyic.com/xx.png")
    @ExcelProperty("商品封面图")
    private String picUrl;

    @Schema(description = "商品轮播图", requiredMode = Schema.RequiredMode.REQUIRED, example = "[https://www.effyic.com/xx.png, https://www.effyic.com/xxx.png]")
