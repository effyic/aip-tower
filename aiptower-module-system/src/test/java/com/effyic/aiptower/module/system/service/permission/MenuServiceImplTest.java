...
import com.effyic.aiptower.module.system.controller.admin.permission.vo.menu.MenuSaveVO;
import com.effyic.aiptower.module.system.dal.dataobject.permission.MenuDO;
import com.effyic.aiptower.module.system.dal.mysql.permission.MenuMapper;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("管理员").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
