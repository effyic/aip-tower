package com.effyic.aiptower.module.ai.framework.ai.core.model;
...
import com.effyic.aiptower.framework.common.util.spring.SpringUtils;
import com.effyic.aiptower.module.ai.enums.model.AiPlatformEnum;
import com.effyic.aiptower.module.ai.framework.ai.config.AiAutoConfiguration;
import com.effyic.aiptower.module.ai.framework.ai.config.AiptowerAiProperties;
...
import com.effyic.aiptower.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import com.effyic.aiptower.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            AiptowerAiProperties.Midjourney properties = SpringUtil.getBean(AiptowerAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(AiptowerAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        AiptowerAiProperties.DouBao properties = new AiptowerAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(AiptowerAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        AiptowerAiProperties.HunYuan properties = new AiptowerAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(AiptowerAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        AiptowerAiProperties.SiliconFlow properties = new AiptowerAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(AiptowerAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        AiptowerAiProperties.XingHuo properties = new AiptowerAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(AiptowerAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        AiptowerAiProperties.BaiChuan properties = new AiptowerAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(AiptowerAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        AiptowerAiProperties.Gemini properties = SpringUtil.getBean(AiptowerAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        AiptowerAiProperties.Grok properties = new AiptowerAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
