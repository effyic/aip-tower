package com.effyic.aiptower.framework.tenant.config;

import com.effyic.aiptower.framework.common.biz.system.tenant.TenantCommonApi;
...
import com.effyic.aiptower.framework.redis.config.AiptowerCacheProperties;
import com.effyic.aiptower.framework.security.core.service.SecurityFrameworkService;
import com.effyic.aiptower.framework.tenant.core.aop.TenantIgnore;
import com.effyic.aiptower.framework.tenant.core.aop.TenantIgnoreAspect;
import com.effyic.aiptower.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.effyic.aiptower.framework.tenant.core.job.TenantJobAspect;
import com.effyic.aiptower.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.effyic.aiptower.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.effyic.aiptower.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.effyic.aiptower.framework.tenant.core.redis.TenantRedisCacheManager;
import com.effyic.aiptower.framework.tenant.core.security.TenantSecurityWebFilter;
import com.effyic.aiptower.framework.tenant.core.service.TenantFrameworkService;
import com.effyic.aiptower.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.effyic.aiptower.framework.tenant.core.web.TenantContextWebFilter;
import com.effyic.aiptower.framework.tenant.core.web.TenantVisitContextInterceptor;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "aiptower.tenant", value = "enable", matchIfMissing = true) // 允许使用 aiptower.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class AiptowerTenantAutoConfiguration {
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     AiptowerCacheProperties aiptowerCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(aiptowerCacheProperties.getRedisScanBatchSize()));
