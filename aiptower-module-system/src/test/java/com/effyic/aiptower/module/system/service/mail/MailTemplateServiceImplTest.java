...
import com.effyic.aiptower.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
...
import com.effyic.aiptower.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static com.effyic.aiptower.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("AIP-Tower")));
        // 测试 code 不匹配
