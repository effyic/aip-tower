...
import com.effyic.aiptower.module.mes.controller.admin.dv.repair.vo.MesDvRepairRespVO;
import com.effyic.aiptower.module.mes.controller.admin.dv.repair.vo.MesDvRepairSaveReqVO;
...
public class MesDvRepairController {
    ...
    @PreAuthorize("@ss.hasPermission('mes:dv-repair:update')")
    public CommonResult<Boolean> confirmRepair(@Valid @RequestBody com.effyic.aiptower.module.mes.controller.admin.dv.repair.vo.MesDvRepairConfirmReqVO confirmReqVO) {
