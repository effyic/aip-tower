package com.effyic.aiptower.module.member.controller.admin.user.vo;
...
public class MemberUserBaseVO {
    ...
    @Schema(description = "邮箱", example = "member@effyic.com")
    ...
    @Schema(description = "头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.effyic.com/x.png")
